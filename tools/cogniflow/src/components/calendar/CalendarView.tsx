...
import { format, startOfMonth, endOfMonth, startOfWeek, endOfWeek, addMonths, addWeeks, eachDayOfInterval, isSameDay, isToday, isSameMonth } from 'date-fns';
          ...
          return (
            ...
            >
              <div className="text-center mb-3">
                <div className={`
                  text-sm font-medium
                  ${isTodayDate ? 'text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400'}
                `}>
        ...
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xl font-semibold ml-4">
            {viewMode === 'month' 
              ...
              : format(currentDate, 'yyyy年MM月 第W周', { locale: zhCN })}
          </h2>
        </div>
